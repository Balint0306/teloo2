...
lyrics: [
  ...
  { 
    id: 20, 
    title: 'Lidokain (feat. ByeAlex)', 
    artist: 'BSW', 
    cover: 'https://i.scdn.co/image/ab67616d00004851bd0d868d1a5a5c15328f0740', 
    videoUrl: 'https://www.dropbox.com/scl/fi/buav3utrl5ypzrg20dtvj/BSW-Lidokain-feat.-ByeAlex.mp4?rlkey=fryxtnnxd4nl6akbkc5gdeitf&st=gnpevxt8&dl=1',
    color: '#1a1a1a',
lyrics: [
  { time: 13, text: "Ma kicsit meghalok, de kelek holnap, eltelt ezer hónap" },
  { time: 18, text: "Felriadok, még mindig álmodok rólad, álmodok rólad..." },
